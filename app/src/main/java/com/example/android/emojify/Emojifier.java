...
class Emojifier {
        ...
        if(faces.size() == 0) {
            ...
            for (int i = 0; i < faces.size(); ++i) {
                ...
                switch( emoji ) {
                    ...
                    default:
                        emojiBitmap = null;
                        Log.w(TAG, "detectFacesAndOverlayEmoji: Unknown emoji! ["+ emoji +"]");
                        break;
                }
    ...
    // Copied from solution, no freaking way tutorial/video described below!
    /**
    ...
    private static Bitmap addBitmapToFace(Bitmap backgroundBitmap, Bitmap emojiBitmap, Face face) {
        ...
        // Scale the emoji so it looks better on the face (EMOJI_SCALE_FACTOR)
